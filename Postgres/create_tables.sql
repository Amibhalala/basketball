...
-- Copy csv data to season_stats table
...
-- Copy csv data to player_data table
...
--Merge data from player_data table with player table
update player 
...
--Reset sequence
SELECT setval('player_player_id_seq', max(player_id)) FROM player;
